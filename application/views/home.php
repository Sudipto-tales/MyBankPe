            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1500">
                        ...
                        <div class="used_app">
                            <ul>
                                <li><img src="<?php echo base_url() ?>assets/images/used01.png" alt="image">
                                </li>
                                <li><img src="<?php echo base_url() ?>assets/images/used02.png" alt="image">
                                </li>
                                <li><img src="<?php echo base_url() ?>assets/images/used03.png" alt="image">
                                </li>
                                <li><img src="<?php echo base_url() ?>assets/images/used04.png" alt="image">
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-in" data-aos-duration="1500">
                        <div class="banner_images image_box1">
                            <span class="banner_image1"> <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/bannerimage1.png" alt="image"> </span>
                            <span class="banner_image2"> <img class="moving_animation"
                                    src="<?php echo base_url() ?>assets/images/bannerimage2.png" alt="image"> </span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="fade-in" data-aos-duration="1500">
                        <div class="banner_images image_box2">
                            <span class="banner_image3"> <img class="moving_animation"
                                    src="<?php echo base_url() ?>assets/images/bannerimage3.png" alt="image"> </span>
                            <span class="banner_image4"> <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/bannerimage4.png" alt="image"> </span>
                        </div>
                    </div>
                    <!-- banner slides end -->
            ...
            <div class="container">
                <div class="features_inner">
                    ...
                    <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                        <img src="<?php echo base_url() ?>assets/images/device-feature.png" alt="image">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="feature_box" data-aos="fade-up" data-aos-duration="1500">
                                    <div class="image">
                                        <img src="<?php echo base_url() ?>assets/images/secure_data.png" alt="image">
                                    </div>
                                    <div class="text">
                                        <h4>Secure Data</h4>
                            ...
                            <div class="col-md-3">
                                <div class="feature_box" data-aos="fade-up" data-aos-duration="1700">
                                    <div class="image">
                                        <img src="<?php echo base_url() ?>assets/images/functional.png" alt="image">
                                    </div>
                                    <div class="text">
                                        <h4>Easy to use</h4>
                            ...
                            <div class="col-md-3">
                                <div class="feature_box" data-aos="fade-up" data-aos-duration="1900">
                                    <div class="image">
                                        <img src="<?php echo base_url() ?>assets/images/live-chat.png" alt="image">
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-3">
                                <div class="feature_box" data-aos="fade-up" data-aos-duration="1900">
                                    <div class="image">
                                        <img src="<?php echo base_url() ?>assets/images/support.png" alt="image">
                                    </div>
                                    <div class="text">
                        ...
                        <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
                            <div class="left_img">
                                <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/modern01.png" alt="image">
                            </div>
                            <!-- UI Image -->
                            <div class="right_img">
                                <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/shield_icon.png" alt="image">
                                <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/modern02.png" alt="image">
                                <img class="moving_position_animatin"
                                    src="<?php echo base_url() ?>assets/images/modern03.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                            <div class="story_img">
                                <img src="<?php echo base_url() ?>assets/images/blogs/story01.png" alt="image">
                    ...
                    <div class="col-md-4">
                        <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                            <div class="story_img">
                                <img src="<?php echo base_url() ?>assets/images/blogs/story02.png" alt="image">
                                <span>45 min ago</span>
                            </div>
                            <div class="story_text">
                    ...
                    <div class="col-md-4">
                        <div class="story_box" data-aos="fade-up" data-aos-duration="1500">
                            <div class="story_img">
                                <img src="<?php echo base_url() ?>assets/images/story03.png" alt="image">
                                <span>45 min ago</span>
                            </div>
                            <div class="story_text">
