        ...
        <div class="row">
          <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="banner_text">
              ...
              <h1>Payment Collection made simple with <span><?= $company_name ?></span> Payment Gateway.
              </h1>

              <p>Put your payment collection in autopilot, seamlessly collect and manage your funds with
                <?= $company_name ?>, experience unmatched success rates.
              </p>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="<?= base_url() ?>assets/images/pg3.svg" alt="image">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="<?= base_url() ?>assets/images/transaction.png" width="550px"
                  alt="image">
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="<?= base_url() ?>assets/images/pg5.webp" alt="image">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6">
            <div class="blog_text">
              <di class="section_title">
                ...
                <p>At <?= $company_name ?>, technology drives everything we do. We are an API-first company, offering best-in-industry
                  developer APIs that are designed for easy integration and seamless scalability.</p>
                <p>Our APIs enable you to plug into powerful payment solutions effortlessly. Plus, with our AI-powered
                  developer chat, you can get instant answers to technical questions, ensuring smooth development and
                  integration every step of the way.</p>
                <p>We can help you make your business payments frictionless just like how UPI apps did for your end
                  customers.</p>
                  <a class="btn" href="https://mybankpe.com/auth/register" data-aos="fade-in" data-aos-duration="1500">Get Started
